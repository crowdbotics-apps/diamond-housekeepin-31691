...
## Project Structure
    ...
    ├── diamond_housekeepin_31691  # Django project configurations
...
1. Clone this repo and `cd diamond_housekeepin_31691`
...
2. Clone this repo and `cd diamond_housekeepin_31691`
